# Sun Fitness Gym — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-sun-fitness-gym/
- **Repo:** `shreekantha3/sindagi-sun-fitness-gym` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-sun-fitness-gym/'` for GitHub Pages project-site hosting.
